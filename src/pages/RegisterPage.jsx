...
import { Mail, Lock, User, Eye, EyeOff, BookOpen, GraduationCap, Shield } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  { value: 'student', label: 'Student',       icon: GraduationCap, desc: 'Chat & learn' },
                  { value: 'admin',   label: 'Administrator',  icon: Shield,         desc: 'Manage documents' },
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: form.role === value ? 'var(--accent-bg)' : '#fff',
                      cursor: 'pointer',
                    }}
                  >
                    <Icon
                      className="w-5 h-5"
                      style={{ color: form.role === value ? 'var(--navy)' : 'var(--text-muted)' }}
                    />
                    <p
                      className="text-sm font-semibold"
                      style={{ color: form.role === value ? 'var(--navy)' : 'var(--text-base)' }}
                    >
                      {label}
                    </p>
